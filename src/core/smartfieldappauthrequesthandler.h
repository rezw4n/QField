/***************************************************************************
              smartfieldappauthrequesthandler.h
              -------------------
              begin                : August 2019
...
#ifndef SMARTFIELDAPPAUTHREQUESTHANDLER_H
#define SMARTFIELDAPPAUTHREQUESTHANDLER_H
 ...
 * Login Dialog, but SmartField does not. The realms (where it should log in to) are just added to the list
 ...
 *
 */
class SmartFieldAppAuthRequestHandler : public QObject, public QgsCredentials, public QgsNetworkAuthenticationHandler
{
    Q_OBJECT

  public:
    SmartFieldAppAuthRequestHandler();
...
#endif // SMARTFIELDAPPAUTHREQUESTHANDLER_H
