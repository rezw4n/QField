...
#ifndef SMARTFIELDCLOUDPROJECTSMODEL_H
#define SMARTFIELDCLOUDPROJECTSMODEL_H
...
class SmartCloudProjectsModel : public QAbstractListModel
{
    Q_OBJECT
  ...
  public:
    ...
    Q_PROPERTY( SmartCloudConnection *cloudConnection READ cloudConnection WRITE setCloudConnection NOTIFY cloudConnectionChanged )

    //! Returns the currently used cloud connection.
    SmartCloudConnection *cloudConnection() const;

    //! Sets the cloud connection.
    void setCloudConnection( SmartCloudConnection *cloudConnection );
  ...
  private:
    ...
    SmartCloudConnection *mCloudConnection = nullptr;
    ...
    SmartCloudProjectsModel::JobStatus getJobStatusFromString( const QString &status ) const;
...
Q_DECLARE_METATYPE( SmartCloudProjectsModel::ProjectStatus )
Q_DECLARE_METATYPE( SmartCloudProjectsModel::ProjectCheckout )
Q_DECLARE_METATYPE( SmartCloudProjectsModel::ProjectCheckouts )
Q_DECLARE_OPERATORS_FOR_FLAGS( SmartCloudProjectsModel::ProjectCheckouts )
Q_DECLARE_METATYPE( SmartCloudProjectsModel::ProjectModification )
Q_DECLARE_METATYPE( SmartCloudProjectsModel::ProjectModifications )
Q_DECLARE_OPERATORS_FOR_FLAGS( SmartCloudProjectsModel::ProjectModifications )


class SmartCloudProjectsFilterModel : public QSortFilterProxyModel
{
    Q_OBJECT

    Q_PROPERTY( SmartCloudProjectsModel *projectsModel READ projectsModel WRITE setProjectsModel NOTIFY projectsModelChanged )
  ...
  public:
    ...
    explicit SmartCloudProjectsFilterModel( QObject *parent = nullptr );

    /**
     * Returns the source cloud projects model from which the filtered list is derived.
     */
    SmartCloudProjectsModel *projectsModel() const;
     ...
     */
    void setProjectsModel( SmartCloudProjectsModel *projectsModel );
  ...
  private:
    SmartCloudProjectsModel *mSourceModel = nullptr;
    ProjectsFilter mFilter = PrivateProjects;
    bool mShowLocalOnly = false;
};

Q_DECLARE_METATYPE( SmartCloudProjectsFilterModel::ProjectsFilter )

#endif // SMARTFIELDCLOUDPROJECTSMODEL_H
