...
Page {
  ...
  ListModel {
    ...
    ListElement {
      ...
      description: qsTr("If disabled, SmartField will use a minimalist internal camera instead of the camera app on the device.<br>Tip: Enable this option and install the open camera app to create geo tagged photos.")
      settingAlias: "nativeCamera"
      isVisible: true
    }
    ListElement {
      title: qsTr("Send anonymized metrics")
      description: qsTr("If enabled, anonymized metrics will be collected and sent to help improve SmartField for everyone.")
          ...
          ColumnLayout {
            ...
            GridLayout {
              ...
              Label {
                ...
                Layout.fillWidth: true
                text: qsTr("To apply the selected user interface language, SmartField needs to completely shutdown and restart.")
                font: Theme.tipFont
              ...
              Label {
                text: qsTr("Found a missing or incomplete language? %1Join the translator community.%2").arg('<a href="https://www.transifex.com/rezw4n/smartfield">').arg('</a>')
                font: Theme.tipFont
                color: Theme.secondaryTextColor
                textFormat: Qt.RichText
                wrapMode: Text.WordWrap
        ...
        ScrollView {
          ...
          ColumnLayout {
            ...
            GridLayout {
              ...
              Label {
                text: qsTr("This value will correct the Z values recorded from the positioning device. If a value of 1.6 is entered, SmartField will automatically subtract 1.6 from each recorded value. Make sure to insert the effective antenna height, i.e. pole length + antenna phase centre offset.")
                font: Theme.tipFont
                color: Theme.secondaryTextColor
  ...
  header: QfPageHeader {
    title: qsTr("SmartField Settings")
