  ...
  ColumnLayout {
    ...
    Rectangle {
        ...
        delegate: Rectangle {
          ...
          RowLayout {
              ...
              source: {
                if (ItemHasThumbnail) {
                  ...
                  case LocalFilesModel.ApplicationFolder:
                    return Theme.getThemeVectorIcon('ic_folder_smartfield_gray_48dp');
            ...
            QfToolButton {
              ...
              onClicked: {
                var gc = mapToItem(smartfieldLocalDataPickerScreen, 0, 0);
          ...
          onClicked: mouse => {
            if (itemMenu.visible) {
              ...
              if (item) {
                ...
                } else if (!smartfieldLocalDataPickerScreen.projectFolderView && (item.itemMetaType === LocalFilesModel.Project || item.itemMetaType === LocalFilesModel.Dataset)) {
      ...
      QfToolButton {
        ...
        property bool isLocalProject: qgisProject && SmartCloudUtils.getProjectId(qgisProject.fileName) === '' && (projectInfo.filePath.endsWith('.qgs') || projectInfo.filePath.endsWith('.qgz')) && platformUtilities.capabilities & PlatformUtilities.UpdateProjectFromArchive
    ...
    Menu {
      ...
      MenuItem {
        id: removeDataset
        enabled: itemMenu.itemMetaType == LocalFilesModel.Dataset && !smartfieldLocalDataPickerScreen.projectFolderView && table.model.isDeletedAllowedInCurrentPath
        visible: enabled
      ...
      MenuItem {
        ...
        enabled: itemMenu.itemMetaType == LocalFilesModel.Folder && !smartfieldLocalDataPickerScreen.projectFolderView && table.model.isDeletedAllowedInCurrentPath
        visible: enabled
    ...
    Menu {
      ...
      MenuItem {
        ...
        onTriggered: {
          Qt.openUrlExternally("https://docs.smartfield.org/get-started/storage/");
        }
      }
    }
